...
|조건 |PIR감지    |LED상태|           동작                                    |
|------|-----------|-------|-------------------------------------------------|
|  1   | 0         |  0    |LED OFF 현 상태 유지                              |
|  2   | 0         |  1    | 타이머 시작(4초 후 OFF)                           |
|  3   | 1         |  0    | 타이머 시작(7초 후 LED가 안켜질 시 에러 메시지 전송 |
|  4   | 1         |  1    |       LED ON                                     |  
...
특정 상황에서 송신부에서 데이터를 받음

|         조건                          |수신 데이터                        |   
|---------------------------------------|----------------------------------|
|                 1                     | "LED ON"                         |   
|                 2                     | "LED OFF"                        |    
|                 3                     |"Error: PIR detected but LED OFF"  |       
|                 4                     |"Error: CDS value too low"         |
|                 5                     |"Error: CDS value too high"        |
|                 6                     |"Error: LED stuck ON"              |
